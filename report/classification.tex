...
The second method which involved using the pre-trained ImageNet model and retraining it with our dataset executed with just 200 epochs got a accuracy of 97.\% with a cross entropy of 0.04. Figure \ref{table:confus}
	...
	\multicolumn{6}{c} {\textbf{Predicted}} \\ \cline{2-6}
       ...
       \multirow{6}{*} {\rotatebox{90}{\textbf{Truth}}} 
           ...
           &  & 1 & 2 & 3 & 4 \\ \cline{2-6}	
			...
			& 1  &  850 \cellcolor[gray]{.8} & 12  & 2 & 2 \\  \cline{2-6}	 
			
			& 2 & 19  &  822 \cellcolor[gray]{.8}& 5 & 20 \\ \cline{2-6}	   
			
			& 3 & 1 & 10 & 854 \cellcolor[gray]{.8} & 24 \\ 
			\cline{2-6}
			
			& 4 & 1 & 1 & 7 & 855\cellcolor[gray]{.8} \\ \cline{2-6}

...
public class defaultbars extends JFrame {

    private static final long serialVersionUID = 1L;

    public defaultbars(String applicationTitle, String chartTitle) {
    ...
    public static void main(String[] args) {
        defaultbars chart = new defaultbars("Browser Usage Statistics", "Which Browser are you using?");
        chart.pack();
